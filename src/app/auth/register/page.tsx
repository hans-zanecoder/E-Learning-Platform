        ...
        <div className="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
          <div className="w-full">
            ...
            <p className="mt-4 text-gray-500 dark:text-gray-400">
              Let's get you all set up so you can verify your personal account and begin your learning journey.
            </p>
            ...
            <form className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2" onSubmit={handleSubmit}>
              ...
              <div>
                <label htmlFor="confirmPassword" className="block mb-2 text-sm text-gray-600 dark:text-gray-200">
                  Confirm password
                </label>
                <input
                  id="confirmPassword"
